...
write.csv(Access, "./data3/p55/CityAccess.csv", row.names = F)
...
write.csv(Access1, "./data3/p55/RoadAccess.csv", row.names = F)
...
write.csv(human, "./data3/p55/human.csv", row.names = F)
...
write.csv(Pop, "./data3/p55/Pop.csv", row.names = F)
...
write.csv(GDP, "./data3/p55/GDP.csv", row.names = F)

# Combining data and create a data frame
CityAccess = read.csv("./data3/p55/CityAccess.csv")
RoadAccess = read.csv("./data3/p55/RoadAccess.csv")
human = read.csv("./data3/p55/human.csv")
GDP = read.csv("./data3/p55/GDP.csv")
Pop = read.csv("./data3/p55/Pop.csv")
...
Man_samp_df = as.data.frame(samp07,samp10,samp13,samp16)
colnames(Man_samp_df) = c("y07", "y11", "y13", "y16")
Data$loss = c( samp07$CID,samp10$CID, samp13$CID,samp16$CID)
table(Data$loss)
...
write.csv(Data, "./data3/p55/data_raw.csv", row.names = F)
Data = read.csv("./data3/data_raw.csv")

Data$loss = c(samp07$CID,samp10$CID,samp13$CID,samp16$CID,samp19$CID)

###
ISO307 = shapefile("E:/NUS/ISO3/2007sample.shp")
ISO310 = shapefile("E:/NUS/ISO3/2010sample.shp")
ISO313 = shapefile("E:/NUS/ISO3/2013sample.shp")
ISO316 = shapefile("E:/NUS/ISO3/2016sample.shp")
ISO319 = shapefile("E:/NUS/ISO3/2019sample.shp") 


Data = read.csv("./data3/data_NEW3.csv")
sum(is.na(Data$loss_prev))
...
write.csv(Data,"./data3/p55/Data1.csv", row.names = F)

Data1 = read.csv("./data3/p55/Data1.csv")
colnames(Data1)
...
write.csv(Data1,"./data3/p55/Mangrove.csv", row.names = F)
head(Data1)
...
library(gbm)
library(caret)
Mangrove = read.csv("E:/Mangrove/data3/p55/mangrove.csv")
summary(Mangrove$loss)


set.seed(10)
idx = sample(1:nrow(Mangrove), 50000)
Mangrove = Mangrove[idx,][c("loss","gdp", "hf", "pop", "city", "road","PA", "coconut", "coffee", "olp", "rice", "rubber", "sugarcane","loss_prev")]
Mangrove$PA = as.factor(Mangrove$PA)
mod_f = as.formula(loss ~ gdp  + hf  + pop  + city + road + PA + coconut + coffee + olp + rice + rubber + sugarcane+loss_prev)
RFmodel = ranger(mod_f,data=Mangrove, num.trees = 300, mtry = 13/3, verbose = T)
saveRDS(RFmodel, "E:/Mangrove/data3/RF2.rds")
test_Mangrove = read.csv("E:/Mangrove/data3/Mangrove_yanzhen.csv")
test_Mangrove = test_Mangrove[c("loss","gdp", "hf", "pop", "city", "road","PA", "coconut", "coffee", "olp", "rice", "rubber", "sugarcane","loss_prev")]
predRF = predict(RFmodel, data = test_Mangrove)
...
saveRDS(RFmodel, "E:/Mangrove/data3/RF1.rds")
...
# Testing
RFmodel = readRDS("E:/Mangrove/data3/RF1.rds")
...
# Prediction
RFmodel = readRDS("E:/Mangrove/data3/RF1.rds")
pred_list = rast("E:/Mangrove/data3/crop_data/2100ssp5pred_list.tif")
...
writeRaster(pred_set, "E:/Mangrove/data3/crop_data/2100ssp1pred_set.tif")
plot(pred_set)

pred_set = rast("E:/Mangrove/data3/p55/pred_set.tif")
...
writeRaster(PredRas, "E:/Mangrove/data3/mangrovepred.tif")
...
ssp12030 = rast("E:/Mangrove/data3/crop_data/2100ssp5mangrovepred.tif")
Area1 = resample(Area,ssp12030)
Area2= mask(Area1, ssp12030)
ssp12030area = Area2*ssp12030 
writeRaster(ssp12030area, "E:/Mangrove/data3/crop_data/2100SSP5area.tif")
plot(Area11)


ssp12030 = rast("E:/Mangrove/carbon/mSOC_Dec_2017_100m.tif")
plot(ssp12030)
